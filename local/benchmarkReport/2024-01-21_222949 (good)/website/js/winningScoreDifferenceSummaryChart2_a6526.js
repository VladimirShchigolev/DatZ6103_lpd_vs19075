...
var chart_winningScoreDifferenceSummaryChart2_a6526 = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart2_a6526'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart2_a6526.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart2_a6526.resize();
});