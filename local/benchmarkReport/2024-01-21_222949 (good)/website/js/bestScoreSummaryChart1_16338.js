...
var chart_bestScoreSummaryChart1_16338 = new Chart(document.getElementById('chart_bestScoreSummaryChart1_16338'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart1_16338.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart1_16338.resize();
});