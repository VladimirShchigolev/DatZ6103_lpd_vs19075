...
var chart_winningScoreDifferenceSummaryChart0_a8323 = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart0_a8323'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart0_a8323.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart0_a8323.resize();
});